    ...
    >
      ...
      <div className="z-10 flex h-full w-full items-center justify-center">
        <div className="uppercase">
          ...
          <h1 className="animated-background bg-gradient-to-r from-purple-50 via-orange-200 to-purple-400 bg-clip-text text-9xl font-bold tracking-tighter text-transparent">
            Andre
          </h1>
